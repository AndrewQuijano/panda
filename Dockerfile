...
COPY --from=p /usr/local/bin/panda* /usr/local/bin/libpanda* /usr/local/bin/qemu-img /package-root/usr/bin/
COPY --from=p /usr/local/etc/panda /package-root/etc/panda
COPY --from=p /usr/local/lib/panda /package-root/usr/lib/panda
COPY --from=p /usr/local/share/panda /package-root/usr/share/panda
